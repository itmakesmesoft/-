...
const UserStatus = () => {
  ...
  const {
    ...
    isValid,
    Msg,
  } = useValidator(); // newPw 기본값 지정. 안하면 오류 undefined 발생 - 이은혁
    ...
    <>
      ...
      <Wrapper>
        ...
        <Status>
          ...
          <Btn className="transparent" onClick={() => setIsOpen(true)}>
            비밀번호 변경
          </Btn>
          <Content>
            <Div className="half">
              <Div className="sec1">
                ...
                <Div>
                  <Moi className="moi">
                    <Circle style={{ background: "#9d9d8e" }}>
                      <GiAcorn size="1.1rem" color="#ffffff" />
                    </Circle>
                    도토리 {data?.info.moiAcorn || "0"} 개
                  </Moi>
                  <Moi className="moi">
                    <Circle style={{ background: "#9d9d8e" }}>
                      <GiCorn size="1.1rem" color="#ffffff" />
                    </Circle>
                    옥수수 {data?.info.moiCorn || "0"} 개
                  </Moi>
                  <Moi className="moi">
                    <Circle style={{ background: "#9d9d8e" }}>
                      <GiWheat size="1.1rem" color="#ffffff" />
                    </Circle>
                    볍씨 {data?.info.moiSeed || "0"} 개
                  </Moi>
                </Div>
              </Div>
              <Div className="sec2">
